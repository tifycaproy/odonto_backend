                        ...
                        <tr id="tr_{{$categoria->id_tratamiento_categoria}}">
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    -->
                                    <a class="btn btn-icons btn-inverse-secondary" href="#" onclick="fun_pregunta_tratamiento({{$categoria->id_tratamiento_categoria}},'tr_')"><i class="fa fa-times" title="Eliminar Paciente"></i></a>
                                </div>
                            </td>
