...
MySQL - 5.5.5-10.1.34-MariaDB : Database - odonto
*********************************************************************
*/
...
insert  into `pacientes`(`id_paciente`,`nombres`,`apellidos`,`id_tipo_sangre`,`id_estado_civil`) values (1,'model-freddy','model-peñalver',2,2),(2,'Rafael Antonio - 8888','de Dausa fffffffffffffffff',1,2),(3,'model-freddy','model-peñalver',2,1);
